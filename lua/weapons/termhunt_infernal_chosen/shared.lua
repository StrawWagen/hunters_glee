...
SWEP.Base = "termhunt_divine_chosen"
DEFINE_BASECLASS( SWEP.Base )

SWEP.Author = "Straw W Wagen."
SWEP.Purpose = "Your powers as the infernal chosen."
SWEP.Instructions = [[
Hold primary to summon your minions.

Hold secondary to charge a firestorm.]]

SWEP.PrintName = "Infernal Chosen"

if CLIENT then
    terminator_Extras.glee_CL_SetupSwep( SWEP, "termhunt_infernal_chosen", "materials/vgui/hud/termhunt_infernal_chosen.png" )
