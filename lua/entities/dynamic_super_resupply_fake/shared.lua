...
function ENT:Initialize()
    if SERVER then
        ...
        local rareCreationOptions = { { "item_ammo_smg1_grenade", 3 }, { "weapon_frag", 4 }, "weapon_stunstick", { "weapon_slam", 2 }, { "termhunt_score_pickup", 3 }, "weapon_shotgun", "weapon_rpg", "weapon_pistol" }
