...
hook.Add( "glee_sv_validgmthink_active", "glee_addbeartrapjobs", function()
    ...
    if #bearTraps >= mapBearTrapCount then nextBearTrapSpawnCheck = CurTime() + GAMEMODE:ScaledGenericSpawnerRate( 60 ) return end
    ...
    nextBearTrapSpawnCheck = CurTime() + GAMEMODE:ScaledGenericSpawnerRate( 60 )
