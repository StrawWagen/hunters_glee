...
AddCSLuaFile( "cl_spectateflashlight.lua" )

AddCSLuaFile( "shoppinggui.lua" )
AddCSLuaFile( "sh_shopshared.lua" )
AddCSLuaFile( "sh_shopitems.lua" )

AddCSLuaFile( "sh_panic.lua" )
AddCSLuaFile( "sh_playerdrowning.lua" )
AddCSLuaFile( "sh_detecthunterkills.lua" )

include( "autorun/server/sv_wallkick.lua" )
include( "shared.lua" )
include( "lib/sv_termfuncs.lua" )
include( "sv_speedhandler.lua" )
include( "sv_navpatcher.lua" )
include( "sv_doorbash.lua" )
include( "sv_mapvote.lua" )
include( "sv_player.lua" )
include( "sv_zcratespawner.lua" )

util.AddNetworkString( "storeResurrectPos" )
util.AddNetworkString( "witnesseddeathconfirm" )
util.AddNetworkString( "resetplayershopcooldowns" )
util.AddNetworkString( "sendshopcooldowntoplayer" )
util.AddNetworkString( "gleeconfirmpurchase" )
