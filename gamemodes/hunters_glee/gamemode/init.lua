...
resource.AddSingleFile( "materials/vgui/hud/data_base.png" )
resource.AddSingleFile( "materials/vgui/hud/data_nodata.png" )
resource.AddSingleFile( "materials/vgui/hud/deadshopicon.png" )
